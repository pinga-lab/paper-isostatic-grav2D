...
The estimated Moho is very close to the true one.
On the other hand, the estimated basement relief is very smooth and does not
retrieve the true one along the first $\approx 200$ km of the profile.
...
In comparison to estimated model obtained in the Step 1 (Figure~\ref{fig:volc-margem-step1}),
this result shows a very smooth lithostatic stress curve as a consequence of the
isostatic constraint. The use of the isostatic has produced a worse estimated Moho, 
...
thinning. The region from $\approx 100$ to $\approx 200$ km, however, shows large 
...
of our algorithm, by using $\sigma = 19$ (equation~\ref{eq:elements-wii}). 

Residuals decreased
Estimated Moho was improved
Estimated basement relief is ...

PAREI AQUI

To solve the problems shown by the estimated model obtained at Step 2 
counteract these problems, we proceed with the Step 3 of our algorithm.
...
\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2}{width=0.6\textwidth}{
	...
	See the caption of Figure~\ref{fig:volc-margem-step1}.
	\label{fig:volc-margem-step2}}
}

\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-sgm_19}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 3.
	See the caption of Figure~\ref{fig:volc-margem-step1}.
