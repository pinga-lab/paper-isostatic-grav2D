...
\plot{volcanic-margin-grafics-estimated-model-alphas_X_1_1_2}{width=0.6\textwidth}{
	...
	The numbers within the colored rectangles represent the density contrasts 
	$\Delta\rho^{(\alpha)}$, $\alpha = w, 1, 2, cc, c0, m$, in kg/m$^{3}$.}
...
\plot{volcanic-margin-grafics-estimated-model-alphas_X_1_1_2_more-known-depths}{width=0.6\textwidth}{
	...
	additional known basement depths (purple symbols).
	See the caption of Figure~\ref{fig:synt-estimated-model-without-isostatic}.
