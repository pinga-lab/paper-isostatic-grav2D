...
\righthead{Isostatic constraint}
...
\plot{volcanic-margin-step2}{width=0.6\textwidth}{
	...
	The remaining information are the same shown in the caption of
...
\plot{pelotas-step3-more-inf}{width=0.6\textwidth}{
	...
	known depths at basement. The remaining information are the same shown in
