...
isostatic constraint, but it requires a great number of a priori information 
...
a priori information at basement. As we can see, the additional a priori information 
...
but by using a limited number of additional a priori information at basement.
Notice that the number of additional a priori information is smaller than that
...
\plot{rifted-margin-model-color}{width=\columnwidth}{
	...
	The continuous black line represents the reference Moho.
...
\plot{volcanic-margin-step1-more-inf}{width=0.6\textwidth}{
	...
	additional a priori information at basement (purple symbols).
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step1}.
...
\plot{volcanic-margin-step3-more-inf}{width=0.6\textwidth}{
	...
	a priori information is small.
	\label{fig:volc-margem-step3-more-inf}}
}

%% application to real data

%\plot{pelotas-location}{width=0.6\textwidth}{
...
%	the study area. The black line indicates the gravity profile over the Pelotas
