...
Different models can be obtained by controlling 
how much the estimated models can deviate from the isostatic equilibrium.
The interpreter can then obtain a set of candidate models that (i) fit the observed data
and (ii) present different degrees of isostatic equilibrium.
...
ﬂood-basalts and tuffs, which are commonly imaged as Seaward Dipping Reflectors (SDR).
