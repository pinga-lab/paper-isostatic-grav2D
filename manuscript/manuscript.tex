...
\plot{pelotas-profile-grafics-estimated-model-alphas_2_1_1_2}{width=0.6\textwidth}{
	{Application to real data on Pelotas basin, Brazil. Results obtained at Step 2 by
	...
	inversion (initial guess data).
	Parameters $\tilde{\alpha}_{0}$, $\tilde{\alpha}_{1}$, $\tilde{\alpha}_{2}$ and 
	$\tilde{\alpha}_{3}$ (equation~\ref{eq:constraint-weights}) have values 
	$10^{1}$, $10^{1}$ and $10^{2}$, respectively, $S_{0} = XX$ km and the density 
	contrasts are those shown in Table~\ref{tab:volcanic-margin-model}. We used an initial
	approximation for $\Delta S$ equal to XXX km.
