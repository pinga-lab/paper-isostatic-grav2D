...
The deepest sub-layer has thickness $\Delta S_{0}$, top at $S_{0}$ and bottom at 
...
geometries of basement and Moho.
...
basement and Moho, as well as the thickness $\Delta S$ defining the base of the 
interpretation model.
The geometries of Layer 1 and of the upper sub-layers forming Layer 2, as well as the 
compensating depth $S_{0}$ (Figure~\ref{fig:interpretation-model}) are predefined by 
...
CHECAR COM A MARCELA $\rightarrow$

Small $\sigma$ values allow small deviations from isostatic equilibrium,
...
$\leftarrow$ CHECAR COM A MARCELA
...
This parameter must be smallest positive number producing an estimated model
...
along the entire profile. A good practice is generate a set of estimates by using different
values for $\sigma$. 
...
\plot{rifted-margin-model-color}{width=\columnwidth}{
	...
	The continuous black lines represent the compensation depth
