...
Few authors have presented local scale methods in space domain for 
simultaneously estimating the basement and Moho reliefs subjected to 
isostatic equilibrium. 

\citet{condi-etal1999} parametrized the subsurface by using a set of
polygonal bodies, each one having uniform density, and proposed a non-linear
inverse problem for estimating the densities and the vertical coordinates 
of the polygon vertices. 

\citet{salem-etal2014} presented one of the few 
...
at rifted margins \citep{worzel1968, watts-moore2017}.
