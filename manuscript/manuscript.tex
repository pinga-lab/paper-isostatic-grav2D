...
impaired the data fit at the regions $\approx 100$ and $\approx 200$ km.
...
\plot{B-model-rifted-margin-grafics-estimated-model-alphas_3_1_2_1_2-sgm_1}{width=0.6\textwidth}{
	{Application to synthetic data. Estimated model $\mathbf{p}^{(3)}$ 
	obtained at the end of Step 3 (Figure~\ref{fig:flow-diagram}) by
	using $\mathbf{p}^{(2)}$ (Figure~\ref{fig:volc-margem-step2}) as
...
\plot{pelotas-profile-grafics-estimated-model-alphas_2_1_2_1_2}{width=0.6\textwidth}{
	...
	obtained at the end of Step 2 (Figure~\ref{fig:flow-diagram}) by
	using $\tilde{\mu}_{0} = 10^{2}$, $\tilde{\mu}_{1} = 10^{1}$, $\tilde{\mu}_{2} = 10^{2}$,
	$\tilde{\mu}_{3} = 10^{1}$ and $\tilde{\mu}_{4} = 10^{2}$.
	...
	(Middle panel) Estimated lithostatic stress curve 
	(equation~\ref{eq:lithostatic-stress-densities}) multiplied by $9.81$ m/s$^{2}$.
