...
\begin{itemize}
	...
	$\alpha = w, 1, \dots, Q, cc, oc, m$, COT position $y_{COT}$ and
...
% Include a flow diagram of the algorithm
...
than $\tilde{\mu}_{2}$.
The values of $\tilde{\mu}_{2}$ and $\tilde{\mu}_{3}$ 
...
pinnacles on the estimated models, around the points associated with the a priori information. 
This effect has already been observed by \citet{barbosa-etal1997}.
