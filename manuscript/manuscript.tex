...
Figure~\ref{fig:simple-model-I-no-isostatic} shows the result obtained by applying 
...
$\tilde{\alpha}_{0} = 0$, $\tilde{\alpha}_{1} = 10^{-8}$, 
$\tilde{\alpha}_{2} = 10^{-6}$ and $\tilde{\alpha}_{3} = 10^{-6}$.
...
Figures~\ref{fig:model-simple-II-no-vinc-isostatic} and \ref{fig:model-simple-II}
...
$\tilde{\alpha}_{0} = 0$, $\tilde{\alpha}_{1} = 10^{-10}$, 
$\tilde{\alpha}_{2} = 10^{-8}$ and $\tilde{\alpha}_{3} = 10^{-8}$.
The result shown in Figure~\ref{fig:model-simple-II} was
obtained by using all constraints. 
The weights $\alpha_{\ell}$ (equation~\ref{eq:goal-function}) were defined by
using $\tilde{\alpha}_{\ell}$ (equation~\ref{eq:constraint-weights}) given by: 
$\tilde{\alpha}_{0} = 10^{-14}$, $\tilde{\alpha}_{1} = 10^{-10}$, 
$\tilde{\alpha}_{2} = 10^{-8}$ and $\tilde{\alpha}_{3} = 10^{-8}$.
...
Figure~\ref{fig:simple-model-I-no-isostatic} and \ref{fig:simple-model-I-all-constraints},
those shown in
Figures~\ref{fig:model-simple-II-no-vinc-isostatic} and \ref{fig:model-simple-II}
...
\plot{simple-model-I-no-isostatic}{width=0.6\textwidth}{
	{Application to synthetic data produced by the simple model I.
	 ...
	 The bottom panel shows the estimated model (colored prisms),
	 the true basement and Moho (dashed white lines), the initial basement
	 and Moho used in the inversion (dashed blue lines), as well as the 
	 known depths at basement (blue triangles) and Moho (green diamonds).
	 ...
	 The estimated model was obtained by using all constraints, except the isostatic
	 constraint.}
}


\plot{simple-model-I-all-constraints}{width=0.6\textwidth}{
	{Application to synthetic data produced by the simple model I.
	 The difference between this figure and Figure~\ref{fig:simple-model-I-no-isostatic}
