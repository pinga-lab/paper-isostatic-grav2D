...
The interfaces separating the prisms represent the basement and the Moho.

The depth of the vertices defining these interfaces are the 
...
Airy-Heiskanen model, which is that stress is constant at some depth within 
the lithosphere.
