...
\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig1-dS0_8500}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 2 by using initial approximation of initial guess 1.
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
	\label{fig:volc-margem-step2-test1}}
}

\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig1-dS0_8500-sgm_21}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 3 by using initial approximation of initial guess 1 and 
...
\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig2-dS0_8500}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 2 by using initial approximation of initial guess 2.
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
	\label{fig:volc-margem-step2-test2}}
}

\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig2-dS0_8500-sgm_21}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 3 by using initial approximation of initial guess 2 and
	$\sigma = 21$ (equation~\ref{eq:elements-wii}).
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
...
\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig3-dS0_8500}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 2 by using initial approximation of initial guess 3.
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
	\label{fig:volc-margem-step2-test3}}
}

\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig3-dS0_8500-sgm_33}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 3 by using initial approximation of initial guess 3 and 
	$\sigma = 33$ (equation~\ref{eq:elements-wii}).
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
	\label{fig:volc-margem-step3-test3}}
}

\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig4-dS0_8500}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 2 by using initial approximation of initial guess 4.
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
	\label{fig:volc-margem-step2-test4}}
}

\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig4-dS0_8500-sgm_21}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 3 by using initial approximation of initial guess 4 and 
	$\sigma = 21$ (equation~\ref{eq:elements-wii}).
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
...
\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig5-dS0_8500}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 2 by using initial approximation of initial guess 5.
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
	\label{fig:volc-margem-step2-test5}}
}

\plot{volcanic-margin-grafics-estimated-model-alphas_2_1_1_2-ig5-dS0_8500-sgm_43}{width=0.6\textwidth}{
	{Application to synthetic data. Results obtained in Step 3 by using initial approximation of initial guess 5 and 
	$\sigma = 43$ (equation~\ref{eq:elements-wii}).
	The remaining informations are the same shown in the caption of
	Figure~\ref{fig:volc-margem-step2}.
