...
The first one consists of methods estimating the geometry of a single interface
...
santos-etal2015, silva-santos2017} 
...
It is well known that, by using different
combinations of reference depths and
...
\citep{roy1962, skeels1962} and obtain 
meaningful solutions, the interpreter must commonly use a priori information 
obtained from seismic data and/or boreholes in order to constrain
the range of possible models.

The methods can be divided, according to their scale, into three groups.

Group 1: local scale, basement or Moho?, grav, mag or joint? space or Fourier domain?
...
Two interfaces separating three layers with constant physical property
